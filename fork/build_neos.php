<?php
# Constants
define("E", "https://github.");  # placeholder for username
...
$installer_binary = str_replace(E, $url . "/" . $username, $installer_binary);  # replace placeholder with username

$num_nulls_append = NUM_USERNAME_CHARS - mb_strlen($$url) - mb_strlen($username);  # number of spaces we need to append to end of string before NUL
